 #randomNumbersQueue
# This program puts 10 random numbers into a queue(list), the program should then output all the values in the queue
...
print ("the queue is now empty")
    ...
    # the issue with the initial code, the f"string" formating was missing
